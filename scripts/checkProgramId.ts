 ...
 *   --idl      Path to IDL file. Default: ./target/idl/vesting.json
...
let url = "localhost";
let idlPath = "./anchor/target/idl/vesting.json";
...
async function checkProgramId() {
  try {
    ...
    const keypairPath = "./anchor/target/deploy/vesting-keypair.json";
      ...
      try {
        ...
        if (idlProgramId !== keypairProgramId) {
          ...
          if (shouldUpdate) {
            ...
            const publicIdlPath = "./public/vesting.json";
